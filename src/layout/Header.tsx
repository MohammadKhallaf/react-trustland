...
const Header = (): JSX.Element => {
  ...
  return (
    <header className="h-screen hero-bg">
      {/* Nav bar */}
      <div className="container-spacing py-3 md:pt-5 md:pb-3 flex flex-row  justify-between md:justify-around align-baseline gap-8 text-white lg:text-xl fixed z-10 shadow-md backdrop-blur-sm bg-zinc-900 bg-opacity-20 ">
